...
export default function DoctorPanel({
  ...
  return (
    <div className="w-80 min-w-80 bg-white border-r border-gray-200 p-6 flex flex-col gap-5 overflow-y-auto">
      <div className="text-xs font-mono tracking-widest text-gray-400 uppercase border-b border-gray-200 pb-3">
        Clinical Input
      </div>
      ...
      {hasMessages && (
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 text-xs text-amber-700 flex gap-2">
          <span className="flex-shrink-0">💡</span>
          <span>
            Rate all three cards and submit before generating the next scenario.
          </span>
        </div>
      )}
      ...
      <div className="border-t border-gray-200 pt-4">
        ...
        <div className="border-2 border-amber-400 rounded-xl p-4 text-center">
          ...
          <div className="text-xs text-gray-400 mt-1 font-mono">
            clarityai.app/<span className="text-emerald-600">view</span>
          </div>
